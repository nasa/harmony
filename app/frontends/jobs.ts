...
import { getCloudAccessJsonLink, getCloudAccessShLink, getEventLinksForJob, getStacCatalogLink, getStatusLink, Link } from '../util/links';
...
function getLinksForDisplay(job: Job, urlRoot: string, statusLinkRel: string): JobLink[] {
  ...
  links.unshift(...getEventLinksForJob(job, urlRoot));
