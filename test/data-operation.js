  ...
  describe('#serialize', () => {
    describe('when its serialized JSON fails schema validation', () => {
      describe('and its "validate" parameter is not passed', () => {
        const call = () => invalidOperation.serialize('0.2.0');
      ...
      describe('and its "validate" parameter is set to true', () => {
        const call = () => invalidOperation.serialize('0.2.0', true);
      ...
      describe('and its "validate" parameter is set to false', () => {
        const call = () => invalidOperation.serialize('0.2.0', false);
        ...
        it('returns its JSON-serialized model', () => {
          expect(call()).equal('{"client":"harmony-test","callback":"http://example.com/callback","sources":[],"format":{},"user":"test-user","subset":{"bbox":[-130,-45,130,45,100]},"version":"0.2.0"}');
        });
      });
    });
    ...
    describe('when using the 0.1.0 schema version', () => {
      ...
      it('returns its JSON-serialized model without the client parameter and the correct 0.1.0 version', () => {
        expect(call()).equal('{"callback":"http://example.com/callback","sources":[],"format":{},"user":"test-user","subset":{"bbox":[-130,-45,130,45]},"version":"0.1.0"}');
      });
    });
  });
});
