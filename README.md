...
You should now be able to view the outputs of the WMS service by pointing a client at the WMS URL for a test collection. Harmony has its own test collection set up for sanity checking harmony with the harmony-gdal backend service available at `http://localhost:3000/C1233800302-EEDTEST/wms`.
